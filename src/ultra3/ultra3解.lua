...
fbl = 2
--分辨率：1280x800填写1，1920x1080p填写2，2560x1440填写3，2560x1600填写4，1980x1200p填写5，1280x1024填写6.需要新坐标请私聊我
yc1 = 500
--长按e的时间，400+当前延迟的平均数值，默认为500ms，如果打开背包后呆住一小段时间才换甲，则降低该值
---------------------------------------------------
-------------------------设置----------------------
---------------------------------------------------
key = "1"
